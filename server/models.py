...
class Restaurant(db.Model, SerializerMixin):
    ...
    restaurant_pizzas = relationship('RestaurantPizza', backref=backref('restaurant'))

    restaurant_pizzas = relationship('RestaurantPizza', back_populates='restaurant', cascade='all, delete-orphan')
    pizzas = association_proxy('restaurant_pizzas', 'pizza',
        creator=lambda pz: RestaurantPizza(pizza=pz))
...
class Pizza(db.Model, SerializerMixin):
    ...
    restaurant_pizzas = relationship('RestaurantPizza', backref=backref('pizza'))

    restaurant_pizzas = relationship('RestaurantPizza', back_populates='pizza', cascade='all, delete-orphan')
    restaurants = association_proxy('restaurant_pizzas', 'restaurant',
        creator=lambda res: RestaurantPizza(restaurants=res))
...
class RestaurantPizza(db.Model, SerializerMixin):
    ...
    def validate_price(self, key, price):
        # if not price:
        #     raise ValueError('Pizza price cannot be blank')
